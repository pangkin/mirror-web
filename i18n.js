...
const translations = {
  ko: {
    ...
    'hero.stat3Value': '안정',
    'about.title': '프로젝트 소개',
    'about.description': 'Pangkin Mirror는 오픈소스 커뮤니티를 지원하기 위해 개인이 운영하는 프로젝트입니다.',
    'about.feature1Title': '커뮤니티 중심',
    'about.feature1Desc': '모든 데이터는 각 오픈소스 커뮤니티에서 제공되고 관리됩니다. 사용에 대한 책임은 최종 사용자에게 있습니다.',
    'about.feature2Title': '비영리',
    'about.feature2Desc': '이 서비스는 상업적 이익 없이 전적으로 커뮤니티의 이익을 위해 운영됩니다.',
    'about.feature3Title': '최신 상태 유지',
    'about.feature3Desc': '최신 상태를 유지하기 위해 매일 02시, 06시, 10시, 14시, 18시, 22시에 자동으로 동기화합니다.',
    'repos.title': '저장소 목록',
    'repos.description': '운영 중인 저장소 목록을 확인하세요.',
    'repos.serverAddress': '서버 주소:',
    'contact.title': '연락하기',
    'contact.description': '문의사항, 이슈 또는 제안 사항이 있으시면 언제든지 연락 주세요.',
    'contact.emailTitle': '이메일',
    'contact.emailDesc': '일반 문의, 지원 또는 피드백은 이메일로 연락하실 수 있습니다.',
    'contact.githubDesc': '소스 코드, 이슈 추적 및 기여를 위해 GitHub에서 프로젝트를 확인하세요.',
    'rokfoss.title': 'ROKFOSS 프로젝트 참여',
    'rokfoss.description': 'Pangkin Mirror는 ROKFOSS 프로젝트 참여 미러로서,<br class="hidden sm:block" />지역 오픈소스 리소스 확장에 기여합니다.',
  ...
  en: {
    ...
    'about.description': 'Pangkin Mirror is a personal project operated on a best-effort basis to support the open-source community.',
    'about.feature1Title': 'Community-Driven',
    'about.feature1Desc': 'All data is provided and managed by its respective open-source community. The responsibility for its use lies with the end-user.',
    'about.feature2Title': 'Non-Profit',
    'about.feature2Desc': 'This service is operated entirely for the community\'s benefit, without any commercial interest.',
    'about.feature3Title': 'Always Up-to-Date',
    'about.feature3Desc': 'To provide the latest data, mirrors are synchronized regularly at 02, 06, 10, 14, 18, 22 (KST).',
    'repos.title': 'Repositories',
    'repos.description': 'A comprehensive list of our actively maintained repositories.',
    'repos.serverAddress': 'Server Address:',
    'contact.title': 'Contact',
    'contact.description': 'For any inquiries, issues, or suggestions, please feel free to reach out.',
    'contact.emailTitle': 'Email',
    'contact.emailDesc': 'For general inquiries, support, or feedback, you can reach me via email.',
    'contact.githubDesc': 'Check out the project on GitHub for source code, issue tracking, and contributions.',
    'rokfoss.title': 'Proud Participant of ROKFOSS',
    'rokfoss.description': 'Pangkin Mirror is proud to be a part of the ROKFOSS project,<br class="hidden sm:block" />contributing to the growth and availability of open-source resources in the region.',
...
const repositories = [
  {
    ...
    mirrors: [
      ...
      { name: 'debian-security', path: '/debian-security/', label: 'Debian-Security' }
    ]
  },
  {
    id: 'opnsense',
    ...
    mirrors: [
      { name: 'opnsense', path: '/opnsense/', label: 'OPNsense' }
    ]
  },
  {
    id: 'proxmox',
    ...
    mirrors: [
      { name: 'proxmox', path: '/proxmox/', label: 'Proxmox' }
    ]
  },
  {
    id: 'rocky',
  ...
  },
  {
    ...
    mirrors: [
      { name: 'archlinux', path: '/archlinux/', label: 'Arch Linux' }
    ]
  },
  {
    id: 'kali',
